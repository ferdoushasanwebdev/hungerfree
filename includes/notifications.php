                        ...
                        <?php foreach ($notifications as $notification) { ?>
                            <li class="list-group-item <?php echo ($notification['not_read'] == 0 ? "bg-secondary text-light" : ""); ?>">
                                ...
                                ?><a class="nav-link" href="postdetails.php?post_id=<?php echo ($notification['not_post']); ?>&id=<?php echo ($notification['not_id']); ?>"><strong><?php echo ($notification['sender_name']) ?></strong> has requested on a post.</a><?php
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        ?><a class="nav-link" href="postdetails.php?post_id=<?php echo ($notification['not_post']); ?>&id=<?php echo ($notification['not_id']); ?>"><strong><?php echo ($notification['sender_name']) ?></strong> has accepted your request on a post.</a><?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } elseif ($notification['not_type'] === 'donated') {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ?><a class="nav-link" href="postdetails.php?post_id=<?php echo ($notification['not_post']); ?>&id=<?php echo ($notification['not_id']); ?>"><strong>Congratulations!</strong> You have donated a food.</a><?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    } ?>
                            </li>
                        <?php } ?>
                    </ul>
